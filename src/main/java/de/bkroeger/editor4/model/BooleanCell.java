...
/**
 * <p>
 * Eine BooleanCell ist eine Implementierung von {@link ICell}.
 * </p>
 *
 * @author berthold.kroeger@gmx.de
 */
public class BooleanCell extends SimpleBooleanProperty implements ICell, ICellChangedListener {

    private static final Logger logger = LogManager.getLogger(BooleanCell.class.getName());
	...
	public BooleanCell(IModel model, String name) {
		super(model, name);
	}

	public BooleanCell(IModel model, String name, Boolean value) {
...
//=========================================================================
	...
	private void calculateFormula() throws CellCalculationException {
		CalculatorService<Boolean> calculator = new CalculatorService<Boolean>();
