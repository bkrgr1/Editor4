...
/**
 * <p>Eine DoubleCell ist eine Implementierung von {@link ICell}.</p>
 * <p>Eine DoubleCell kann entweder einen festen Double-Wert enthalten, oder eine Formel,
 * die zu einem Double-Wert führt.</p>
 * <p>Wenn eine Formel vorhanden ist, kann diese sich auf andere Zellen beziehen.
 * In diesem Fall wird bei der anderen Zelle eine Listener registriert, damit man informiert wird,
 * wenn sich der Wert der anderen Zelle ändert. In diesem Fall muss die Formel neu 
 * ausgewertet werden.</p>
 *
 * @author berthold.kroeger@gmx.de
 */
public class DoubleCell extends SimpleDoubleProperty implements ICell, ICellChangedListener {

    private static final Logger logger = LogManager.getLogger(DoubleCell.class.getName());
	...
	public boolean isFormulaValid() { return this.isFormulaValid; }
	
	/**
	 * <p>Liste der Listener, die diese Zelle in einer Formel verwenden.</p>
	 */
	...
	/**
	 * <p>Die Formel zur Berechnung des Zellwertes.</p>
	 */
	...
	public DoubleCell(IModel model, String name) {
		super(model, name);
	}
	
	public DoubleCell(IModel model, String name, Double value) {
	...
	/**
	 * Liefert den primitiven Wert der Zelle.
	 * Wenn notwendig wird der Zellwert neu berechnet.
	 */
	public double get() {
	...
	/**
	 * Der Wert dieser Zelle hat sich geändert.
	 * Informiere alle anderen Zellen, die diese Zelle in ihrer Formel referenzieren.
	 */
	@Override
	...
	/**
	 * Eine andere Zelle, die in der Formel dieser Zelle referenziert wird,
	 * hat sich geändert. Die Formel muss neu ausgewertet werden.
	 */
	@Override
