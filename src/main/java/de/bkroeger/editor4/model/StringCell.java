...
/**
 * <p>
 * Eine StringCell ist eine Implementierung von {@link ICell}.
 * </p>
 *
 * @author berthold.kroeger@gmx.de
 */
public class StringCell extends SimpleStringProperty implements ICell, ICellChangedListener {

    private static final Logger logger = LogManager.getLogger(StringCell.class.getName());
	...
	public StringCell(IModel model, String name) {
		super(model, name);
	}

	public StringCell(IModel model, String name, String value) {
...
//=========================================================================
	...
	private void calculateFormula() throws CellCalculationException {
		CalculatorService<String> calculator = new CalculatorService<String>();
